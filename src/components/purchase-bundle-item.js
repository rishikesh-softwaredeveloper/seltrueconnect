...
const PurchaseBunldeItem = (bundleItem) => {
    ...
    const bundleDetails = (item) => {
        navigation.navigate('PurchaseBundleOrderListScreen', { "bundleItem": item })
    }
                    ...
                    <View style={styles.sub_container}>
                        <View style={{ borderWidth: 0, borderColor: "#CCC", margin: 0, padding: 10, borderRadius: 0, width: '60%' }}>
                            ...
                            <View style={{ paddingBottom: 5 }}>
                            {
                                ...
                                <TouchableOpacity style={{ paddingBottom: 5, flexDirection: 'row', justifyContent: 'space-between' }} onPress={()=>{
                                    if(dealer[0].category_id == 2 ||  dealer[0].category_id == 3){
                                        if(bundleItem[keys].bundle_status != 'SOLD'){
                                            setisVisible(true)
                                        }    
                                    }
                                    // bundleItem[keys].bundle_status != 'SOLD' || dealer[0].category_id == 2 ||  dealer[0].category_id == 3 ? setisVisible(true):null
                                    }}>
                                ...
                                <View style={{ paddingBottom: 0, flexDirection: 'row', justifyContent:'flex-start' }}>
                                    <Text style={{ fontWeight: '500',color: "#8F8C8B" ,textDecorationLine: 'line-through',fontSize:14,marginLeft:10,fontFamily:'serif'}}>&#8377; {bundleItem[keys].purchase_price}</Text>
...
export default PurchaseBunldeItem;