                        ...
                        <View style={{ borderWidth: 0, borderColor: "#CCC", margin: 0, padding: 10,paddingBottom:5, borderRadius: 0, width: '60%' }}>
                            <View>
                                <TouchableOpacity style={{ paddingBottom: 0 }} onPress={()=>setisVisible(true)}>
                                    ...
                                    <Text style={{paddingBottom:5,color:'#000'}}>AMOUNT: {voucherItem[keys].amount} </Text>
                                    <Text style={{paddingBottom:5,color:'#000'}}>VALID: {voucherItem[keys].valid == 'Y'?"YES":"NO"} </Text>
                                    <Text style={{paddingBottom:5,color:'#000'}}>NAME: {voucherItem[keys].name}</Text>
                                    <Text style={{paddingBottom:5,color:'#000'}}>MOBILE: {voucherItem[keys].mobile}</Text>
                                    <Text style={{paddingBottom:5,color:'#000'}}>ADDRESS: {voucherItem[keys].address}</Text>
                                    <Text style={{paddingBottom:5,color:'#000'}}>CITY: {voucherItem[keys].city}</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                    </View>
