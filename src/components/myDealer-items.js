...
const MyDealerItem = (vendorListItem) => { 
                            ...
                            <View style={{flexDirection:'row'}}>
                                <View style={{ paddingBottom: 0 }}>
                                    <View style={{flexDirection:'row'}}>
                                        ...
                                        <Text style={{paddingBottom:5,color:'#000'}}>{vendorListItem[keys].vendor_name} </Text>
                                    </View>
                                    <View style={{flexDirection:'row'}}>
                                    ...
                                    <View style={{flexDirection:'row'}}>
                                        <Text style={{paddingBottom:5,width:"30%",fontWeight:'bold',color:'#000'}}>Category:</Text>
                                        <Text style={{paddingBottom:5,color:'#000'}}>{vendorListItem[keys].category_name} </Text>
                                    </View>
                                </View>
                            </View>
