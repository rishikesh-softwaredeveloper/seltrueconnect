...
import SoldBunldeItem from '../../components/sold-bundle-item';
...
import DistPaymentSoldInfo from '../../components/dist-payment-sold-info';

const SoldOrderListScreen = ({ route }) => {
    ...
    <View style={{ flex: 1 }}>
      {
        spinner1 ? (
          ...
          <View style={{flex:5,padding:10,justifyContent:'center',width:'90%',marginLeft:20}}>
            <DistPaymentSoldInfo paymentItem={paymentdata}/>
            <View style={{borderWidth:1,padding:10,borderRadius:20}}>
              ...
              <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                ...
                <Text style={{color:'#000',fontWeight:'bold'}}>{Dispatch.name}</Text>
              </View>
              <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                <Text style={{color:'#000',fontWeight:'bold'}}>Company</Text>
                <Text style={{color:'#000',fontWeight:'bold'}}>{Dispatch.company}</Text>
              </View>
              <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                <Text style={{color:'#000',fontWeight:'bold'}}>Vendor Code</Text>
                <Text style={{color:'#000',fontWeight:'bold'}}>{Dispatch.vendor_code}</Text>
              </View> 
              <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                <Text style={{color:'#000',fontWeight:'bold'}}>Dispatch Address</Text>
                <Text style={{color:'#000',fontWeight:'bold'}}>{Dispatch.dispatch_address}</Text>
              </View> 
              <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                <Text style={{color:'#000',fontWeight:'bold'}}>Pin Code</Text>
                <Text style={{color:'#000',fontWeight:'bold'}}>{Dispatch.pincode}</Text>
              </View>
              <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                <Text style={{color:'#000',fontWeight:'bold'}}>City</Text>
                <Text style={{color:'#000',fontWeight:'bold'}}>{Dispatch.city}</Text>
              </View>
              <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                <Text style={{color:'#000',fontWeight:'bold'}}>State</Text>
                <Text style={{color:'#000',fontWeight:'bold'}}>{Dispatch.state}</Text>
              </View>
              <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                <Text style={{color:'#000',fontWeight:'bold'}}>PAN No</Text>
                <Text style={{color:'#000',fontWeight:'bold'}}>{Dispatch.pan_card}</Text>
              </View>
              <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                <Text style={{color:'#000',fontWeight:'bold'}}>GSTIN No</Text>
                <Text style={{color:'#000',fontWeight:'bold'}}>{Dispatch.gst_no}</Text>
              </View>  
            </View>
          </View>
        )
      }
      {
        spinner ? (
          ...
          <View style={{flex:4}}>
            <FlatList
              data={data}
              renderItem={({ item }) => <SoldBunldeItem bundleItem={item} />}
...
export default SoldOrderListScreen;