...
const PurchaseBundleOrderListScreen = ({ route }) => {
      ...
      </View>
      {
        spinner ? (
          ...
          <FlatList
            ...
            renderItem={({ item }) => <PurchaseBundleItemsList bundleItem={{...item,"bundleStatus":bundleItem.bundleItem['bundle_status']}} />}
...
export default PurchaseBundleOrderListScreen;